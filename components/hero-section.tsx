...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen overflow-hidden">
        ...
        <div className="container-custom text-center text-white">
          <Reveal>
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold leading-none tracking-tight mb-6">
              <AnimatedText text="英伦卫浴" delay={0.5} />
              <br />
              <span className="italic font-light">
                <AnimatedText text="臻美生活." delay={1.1} />
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            ...
            >
              源自英国伯明翰，1967年创立 — 历久弥新的工艺品质，为您创造臻美舒适的家居生活空间。
            </motion.p>
          </Reveal>
        </div>
      </motion.div>
      ...
      >
        <BlurPanel className="mx-4 mb-6 px-3 py-4 bg-black/24 backdrop-blur-md border-white/20">
          <div className="flex items-center justify-center gap-3 md:gap-6 text-white/90">
            <div className="flex items-center gap-1.5">
              <PackageCheck className="w-4 h-4 text-green-400" />
              <span className="text-xs md:text-sm">免费配送</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Rocket className="w-4 h-4 text-amber-400" />
              <span className="text-xs md:text-sm">快速交付</span>
            </div>
            <div className="flex items-center gap-1.5">
              <ShieldCheck className="w-4 h-4 text-blue-400" />
              <span className="text-xs md:text-sm">终身保障</span>
            </div>
          </div>
        </BlurPanel>
      </motion.div>
