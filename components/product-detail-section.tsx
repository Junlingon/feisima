...
const productParams: Record<string, { label: string; value: string }[]> = {
  ...
  // 实木浴室柜系列
  "3": [
    { label: "主柜", value: "雪花石膏+格斯胡桃色" },
    { label: "镜子", value: "玻璃+雪花石膏" },
    { label: "台面", value: "水晶白天然大理石" },
  ],
  "6": [
    { label: "主柜", value: "影木绿+哑黑" },
    { label: "镜子", value: "玻璃+仿古金" },
    { label: "台面", value: "铂金钻天然大理石" },
  ],
  "9": [
    { label: "主柜", value: "复古绿金属漆" },
    { label: "镜子", value: "玻璃+亚克力" },
    { label: "台面", value: "实心不锈钢/意大利金" },
  ],
  "12": [
    { label: "主柜", value: "冷松绿金属漆" },
    { label: "镜子", value: "玻璃+冷松绿金属漆" },
    { label: "台面", value: "普拉达绿天然大理石" },
  ],
  "15": [
    { label: "主柜", value: "公爵胡桃色" },
    { label: "镜子", value: "玻璃+公爵胡桃色" },
    { label: "台面", value: "宝格丽白天然大理石" },
  ],
}
