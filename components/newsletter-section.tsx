            ...
            <BlurPanel className="p-8 lg:p-12 bg-white/40 backdrop-blur-md grain-texture">
              <div className="text-center mb-8">
                <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                  <AnimatedText text="领先体验 " delay={0.2} />
                  <span className="italic font-light">
                    <AnimatedText text="英伦品质." delay={0.5} />
                  </span>
                </h2>
                <p className="text-lg text-neutral-600">
                  率先了解新品发布、设计理念，以及限量产品的独家优先购买权。
                </p>
              </div>
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">欢迎加入VIESMAR菲斯玛</h3>
                  <p className="text-neutral-600">
                    感谢您的订阅。您将收到我们的最新资讯，包括独家见解和新品发布信息。
                  </p>
                </motion.div>
              )}

              <p className="text-xs text-neutral-500 text-center mt-6">
                我们尊重您的隐私。您可以随时取消订阅。请阅读我们的{" "}
